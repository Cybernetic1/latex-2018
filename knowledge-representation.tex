...
\section{Plan B: Graph neural networks}
\label{graph-NN}
...
Scott 的解决办法是在 domain $D$ 上引入 \textbf{Scott topology}，然后只考虑 $D \rightarrow D$ 的\textbf{连续函数}。 后者的数量较少，所以避开了 Cantor 勃论。 
